...
import DummyComponentApplicationContainer, { reducers, sagas } from './DummyComponentApplicationContainer';
...
class DummyComponentApplicationApplication extends React.Component {
  render() {
...
export default DummyComponentApplicationApplication;
