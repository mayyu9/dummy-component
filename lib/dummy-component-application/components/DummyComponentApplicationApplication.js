...
var _DummyComponentApplicationContainer = require('./DummyComponentApplicationContainer');

var _DummyComponentApplicationContainer2 = _interopRequireDefault(_DummyComponentApplicationContainer);
...
var store = (0, _redux.createStore)((0, _redux.combineReducers)(_DummyComponentApplicationContainer.reducers), (0, _redux.compose)((0, _redux.applyMiddleware)(sagaMiddleware)));

_DummyComponentApplicationContainer.sagas.map(function (saga) {
...
var DummyComponentApplicationApplication = function (_React$Component) {
  _inherits(DummyComponentApplicationApplication, _React$Component);

  function DummyComponentApplicationApplication() {
    _classCallCheck(this, DummyComponentApplicationApplication);

    return _possibleConstructorReturn(this, (DummyComponentApplicationApplication.__proto__ || Object.getPrototypeOf(DummyComponentApplicationApplication)).apply(this, arguments));
  }

  _createClass(DummyComponentApplicationApplication, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_DummyComponentApplicationContainer2.default, {
            patientId: patientId,
            service: service,
            key: 'DUMMY_COMPONENT_APPLICATION_APP'
          })
        )
      );
    }
  ...
  return DummyComponentApplicationApplication;
}(_react2.default.Component);

DummyComponentApplicationApplication.propTypes = propTypes;

exports.default = DummyComponentApplicationApplication;